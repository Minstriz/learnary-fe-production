  ...
  return (
    ...
    >
      ...
      <div className="mr-10 flex justify-end gap-2">
        ...
        <div
          className="flex w-full overflow-x-scroll overscroll-x-auto scroll-smooth py-5 [scrollbar-width:none] md:py-5"
          ref={carouselRef}
        ...
        >
          ...
          <div
            className={cn(
              ...
              // "mx-auto max-w-7xl", // mở class max-w-7xl nếu muốn card trải dài full width màn hình 
            )}
          >
          ...
          <div className="fixed inset-0 z-50 h-screen overflow-auto">
            ...
            >
              ...
              <div className="relative w-fit">
                <span
                  className="absolute inset-0 bg-white/30 backdrop-blur-md rounded z-0"
                  aria-hidden="true"
                />
                <motion.p
